...
contract TokenTransferor is OwnerIsCreator {
    ...
    // Used when trying to withdraw Ether but there's nothing to withdraw
    ...
    // Mapping to keep track of allowlisted destination chain
    ...
    /// @dev Updates the allowlist status of a destination chain for transaction
    ...
    /// @param _destinationChainSelector The identifier (aka selector) of the destination chain
    /// @param _receiver The address of the recipient on the destination chain
        ...
        returns (bytes32 messageId)
    {
        ...
        // address(linkToken) means fee are paid in LINK
        ...
        returns (Client.EVM2AnyMessage memory)
    {
        ...
        return Client.EVM2AnyMessage({
            ...
            data: "", // No data is being sent
            tokenAmounts: tokenAmounts, // Set the token amounts
